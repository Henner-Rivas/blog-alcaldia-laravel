...
<div class="d-flex justify-content-between">
    ...
    <a class=" btn btn-secondary " href="{{route('admin.planes.create')}}">Crear
        plan</a>
...
<div class="card">
    ...
    <div class="card-header">
        <form action="{{route('admin.planes.index')}}" method="GET" class="d-flex">
            ...
            <tr class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <td width="10px">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{route('admin.planes.edit',$plane)}}">
                            Editar
                        </a>
